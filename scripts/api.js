(function (global) {
  ...
  async function tryFetchAF(lg) {
    ...
    // and the SEASON=2025 from API_CONFIG.
    const fromDate = lg.startDate;   // "2025-07-01"
    const toDate   = lg.endDate;     // "2026-05-25" etc.

    const params = new URLSearchParams({
      league: lg.id,
      season: FBL.API_CONFIG.SEASON, // 2025 -> 2025/26 season
      from:   fromDate,
      to:     toDate,
    });
