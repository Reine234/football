(function () {
  ...
  const DICT = {
    fr: {
      ...
      // =========================
      // ✅ NEW (Wallet page keys)
      // =========================
      "wallet.brand": "FansWallet",

      // ✅ these are the ones from your screenshot (raw keys shown)
      "wallet.currentBalance": "Solde courant",
      "wallet.bonusBalance": "Solde bonus",

      // keep label versions too (harmless + compatible)
      "wallet.currentBalanceLabel": "Solde courant",
      "wallet.bonusBalanceLabel": "Solde bonus",
      ...
      "wallet.makeDeposit": "Faire un dépôt",
      "wallet.withdrawTitle": "Retirer des fonds",

      "wallet.providerMtn": "MTN Mobile Money",
      "wallet.providerOrange": "Orange Money",

      "wallet.amountFcfa": "Montant (FCFA)",
      "wallet.amountPlaceholderDeposit": "ex. 5000",
      "wallet.amountPlaceholderWithdraw": "ex. 10000",
    ...
    en: {
      ...
      // keep label versions too (harmless + compatible)
      "wallet.currentBalanceLabel": "Current Balance",
      "wallet.bonusBalanceLabel": "Bonus Balance",
      ...
      "wallet.amountFcfa": "Amount (FCFA)",
      "wallet.amountPlaceholderDeposit": "e.g. 5000",
      "wallet.amountPlaceholderWithdraw": "e.g. 10000",
